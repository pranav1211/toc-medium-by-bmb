...
1. **Download the release** — [click **Here** to download the Zip.](https://github.com/pranav1211/toc-medium-by-bmb/archive/refs/tags/1.2.zip)
...
### Changelog
    ...
    V1.2
    - fixed an issue where the urls being used were edit ones
    - added an auto load popup

    V1.1
    - Created the Table of contents generator
